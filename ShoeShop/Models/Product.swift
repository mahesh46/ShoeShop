...
extension Product {
    static var productList = [
        Product(name: "Nike Air", image: "shoes1", price: 39, desc: "Nike Air is our iconic innovation that uses pressurized air in a durable, flexible membrane to provide lightweight cushioning. The air compresses on impact and then immediately returns to its original shape and volume, ready for the next impact."),
        Product(name: "Nine West Women's Heels", image: "shoes2", price: 59, desc: "A chunky heel heightens the on-trend style of a chic sandal finished with a slim, adjustable ankle strap. 1/2 inch heel (size 8.5), 1/2 inch ankle strap height, Adjustable ankle strap with buckle closure, Lightly padded footbed, Textile upper/synthetic lining and sole, Imported"),
        Product(name: "Pink Taylor Heels", image: "shoes3", price: 29, desc: "Lulus Exclusive! No one does it quite like the Lulus Taylor Blush Suede Ankle Strap Heels! Whether you choose to dress them up or down, these vegan suede, single sole heels will stun with their slender toe strap, and adjustable ankle strap (with gold buckle)."),
        Product(name: "adidas Kids", image: "shoes4", price: 25, desc: "From the basketball court to the classroom. Everyone deserves a pair of adidas Superstars Shoes. This kids' version celebrates 50 years of the classic shell-toe design. From the distinctive serrated 3-Stripes to the comfortable rubber cupsole, this anniversary edition honors an icon. Whether they sport all white, all black or something in between, these shoes keep little ones looking fresh."),
        Product(name: "All Heart Canvas", image: "shoes5", price: 89, desc: "The Converse Chuck Taylor All Star Crafted With Love High Top Casual Shoes are imported. Wear your heart on your shoes instead of your sleeve when you put on the Girls' Big Kids' Converse Chuck Taylor All Star Crafted With Love High Top Casual Shoes. These are the classic All Stars you with cute heart design details that are perfect for showing your outfit some love."),
